            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section-tittle text-center mb-55">
                        <p>STATE OF STOCK AND AVAILABILITY</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">ANTIMICROBIANS</span>
                                ...
                                <a href="customer/index.php" class="border-btn border-btn2">Purchase Medicine</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">CONSOMMABLE MEDICAUX</span>
                                <p class="mb-25">High Stock </p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="<?= SITE_URL; ?>/public/assets2/img/icon/check.svg" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="properties mb-30">
                        <div class="properties__card">
                            ...
                            <div class="properties__caption">
                                <span class="month">SOLUTIONS FOR INJECTION</span>
                                <p class="mb-25">High Stock </p>
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="<?= SITE_URL; ?>/public/assets2/img/icon/check.svg" alt="">
