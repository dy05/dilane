                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s" >
                        ...
                        <div class="cat-cap">
                            ...
                            <p>We supply the world highest drugs in the society and abroad</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>We're credited to deliver malaria medical drugs </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>We distribute stomach drugs to medical entities </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="left-content2">
                ...
                <div class="section-tittle2 mb-20 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                    <div class="front-text">
                        ...
                        <p>>We are an innoative company and one of the greatest supplier of pharmaceutical products in the country. We offer cheap prices and good promotion for your first purchase in bulk.
                            we import and distribute new technology medical equipments, medical drugs and all medical surrounding needs.</p>
                        <p class="mb-40">Our customers are our first target, we relate their need to our supply, 
                            we studied the medical environment in cameroun and we came out to import the most essential for saving camerounian lives</p>
                        <a href="customer/index.php" class="border-btn">Start medical Purchase</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="home-blog-single mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="blog-img-cap">
                            ...
                            <div class="blog-cap">
                                ...
                                <h3><a href="blog_details.php">Your Massif Solutions ready for Use</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="home-blog-single mb-30 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".6s">
                        <div class="blog-img-cap">
                            ...
                            <div class="blog-cap">
                                ...
                                <h3><a href="blog_details.php">Your Antibiotic Ready for Use Optionss</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
