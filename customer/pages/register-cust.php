...
$qry = "insert into members(name,Phone_N°,Username,dor,usertype,gender,amount,Profession,password,status) values ('$name','$Phone_N°','$Username', CURRENT_TIMESTAMP,'$usertype','$gender','0','','$Profession','$password','Pending')";
