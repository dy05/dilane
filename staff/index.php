...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/public/assets2/img/favicon.ico">
...
<div id="loginbox">
    <form id="loginform" method="POST" class="form-vertical" action="#">
        ...
        <div class="form-actions center">
            ...
            <button type="submit" class="btn btn-block btn-large btn-warning" title="Log In" name="login"
                    value="Admin Login">Staff Login
            </button>
        </div>
    </form>
    <?php
    ...
    ?>
    <div class="pull-left">
        <a href="/login.php"><h6>Login Now</h6></a>
    </div>
</div>
