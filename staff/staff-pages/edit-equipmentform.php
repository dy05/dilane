...
<!--Header-part-->
<div id="">
  <h1><a href="dashboard.html">pharmaceuticalms Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Equipments</a> <a href="#" class="current">Edit pharmaceutical Equipments</a> </div>
  <h1> pharmaceutical Equipment Entry Form</h1>
</div>
          ...
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block blue span8">(237) 0000-0000</span> 
                </div>
            </div>
            <div class="control-group">
