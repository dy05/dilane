...
<!--Header-part-->
<div id="">
  <h1><a href="dashboard.html">pharmaceuticalms Staff A/C</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="tip-bottom">Manage pharmaceutical Equipments</a> <a href="#" class="current">Update Equipment</a> </div>
  <h1>Update pharmaceutical Equipment</h1>
</div>
