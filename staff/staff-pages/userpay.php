...
<!--Header-part-->
<div id="">
  <h1><a href="dashboard.php">pharmaceutical <br> system</a></h1>
</div>
<!--close-Header-part--> 
                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #pharmaceuticalms_<?php echo(rand(100000,10000000));?> <br> 14401  Ndokoti Douala, <br>Cameroon </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="alignright"><?php echo 'cfa'.$amount?></td>
                                                                    </tr>
                                                                   
                                                                    
                                                                    <tr class="total">
                                                                        <td class="alignright" width="80%">Total Amount</td>
                                                                        <td class="alignright">cfa<?php echo $amountpayable; ?></td>
                                                                    </tr>
                                                                </tbody></table>
                                                            </td>
                                                        </tr>
