...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="attendance.php" class="current">Manage Usual Purchase</a> </div>
    <h1 class="text-center">Usual Purchase List <i class="icon icon-calendar"></i></h1>
  </div>
