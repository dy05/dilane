...
<div id="sidebar" ><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='equipment'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="icon icon-cogs"></i> <span>Pharmaceutical Equipment</span> </a>
      <ul>
        <li><a href="equipment.php">List pharmaceutical Equipment</a></li>
    ...
    <li class="<?php if($page=='attendance'){ echo 'active'; }?>"><a href="attendance.php"><i class="icon icon-calendar"></i> <span>Manage Usual Purchase</span></a></li>
