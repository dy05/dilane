...
<link rel="stylesheet" href="../public/css/matrix-style.css" /> here
...
<!--Header-part-->
<div id="">
  <h1><a href="index.php">pharmaceutical <br> System</a></h1>
</div>
<!--close-Header-part--> 
    ...
    <div class="row-fluid">
      ...
      <div class="span6">
       ...
       <div class="widget-box">
        ...
        <?php
            $qry="SELECT * FROM todo WHERE user_id='".$_SESSION['user']->id."'";
          ...
          <div class="widget-content nopadding collapse in" id="collapseG2">
            <ul class="recent-posts">
              ...
              <?php
                ...
                while($row=mysqli_fetch_array($result)){
                  echo "<div class='user-thumb'> <img width='70' height='40' alt='User' src='public/img/demo/av1.jpg'> </div>";
