      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="row-fluid">
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  <thead>
                    <tr>
                      ...
                      <th class="head0 right">Usual Purchase Count</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php echo 'cfa'.$row['amount']; ?></div></td>
                ...
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  cfa<?php echo $row['amount']; ?>/-</h4>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Dear Member <?php echo $row['fullname']; ?>,<br/> <br/>Your Membership is currently <?php echo $row['status']; ?>! <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of the whole team</p>
                </div>
                <div class="pull-right">
                  <h4><span>Approved By: pharmaceuticalms</h4>
                  <p class="text-center">Note:AutoGenerated</p> </div>
