        ...
        <ul class="nav">
          ...
          <li class="nav-item pt-3">
            <a class="nav-link d-block" href="index2.php">
               <!-- <img class="sidebar-brand-logo" src="../assets/images/logo2.svg" alt="" /> 
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/product-tablecustomer.php">
              <i class="mdi mdi-compass-outline menu-icon"></i>
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-12 stretch-card grid-margin">
                <div class="card color-card-wrapper">
                    ...
                    <a class="nav-link d-block" href="pages/tables/product-tablecustomer.php">
