        ...
        <!-- partial -->
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group row">
                        <label for="exampleInputProductname" class="col-sm-3 col-form-label">Product Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputProductname" placeholder="name" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputQuantity" class="col-sm-3 col-form-label">Quantity</label>
                        <div class="col-sm-9">
                          <input type="email" class="form-control" id="exampleInputQuantity" placeholder="Quantity" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputPrice" class="col-sm-3 col-form-label">Price</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputPrice" placeholder="Price" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputexpiring Date" class="col-sm-3 col-form-label">Expiring Date</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputexpiringdate" placeholder="ExpiringDate" />
                        </div>
                      </div>
          ...
          <!-- <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024 <a href="https://www.bootstrapdash.com/" target="_blank">PFG Dashboard</a>. All rights reserved.</span>
