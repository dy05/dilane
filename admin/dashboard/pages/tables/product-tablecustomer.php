    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="#" class="nav-link flex-column">
              <div class="nav-profile-image">
                <img src="../../../assets/images/faces/face17.jpg" alt="profile" />
          ...
          <li class="nav-item">
            <a class="nav-link" href="product-tablecustomer.php">
              <i class="mdi mdi-compass-outline menu-icon"></i>
                ...
                <form class="d-flex align-items-center" action="#">
                  <div class="input-group">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr class="table-info">
                            ...
                            <button type="button" class="btn btn-danger btn-icon-text"> Select <i class="mdi mdi-file-check btn-icon-append"></i>
                          </button>
                          <button type="button" class="btn btn-labeled btn-danger"> Abort <i class="mdi mdi-trash btn-icon-trash"></i>
                          </button>
                        </div>
                          </td>
                          </tr>
                      ...
                      <a class="nav-link d-block" href="../../index2.php"> 
                      <div class="template-demo">
